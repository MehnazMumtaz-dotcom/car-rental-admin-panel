      ...
      <div className="ml-auto w-full sm:w-[520px] lg:w-[440px] h-full bg-white shadow-2xl flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-3 p-5 bg-gray-50">
          ...
          <div className="p-4 bg-white border rounded-lg">
            ...
            <p className="text-lg font-semibold">{customer.bookings}</p>
          </div>
        ...
        {/* CONTENT */}
        <div className="flex-1 overflow-y-auto p-5 bg-gray-50 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
          ...
          {activeTab === "activity" && (
            <div className="space-y-3">
              ...
              {[
                ...
                <div
                  key={i}
                  className="bg-white border-l-4 border-blue-500 p-3"
                >
                  {item}
                </div>
              ))}
